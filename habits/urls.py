...
from .views import UserCategoryList, CategoryDelete, CategoryCreate, CategoryContent, UpdateContent, ActionCreate, MainPage, CategoryAlarmTimeUpdate, CategoryRandomHabitView, TriggerAlarmTask, UpdateCategoryChooseView, UserAction
...
urlpatterns = [
    ...
    path('<int:category_id>/choose/', UpdateCategoryChooseView.as_view(), name='update-category-choose'),
]
